...
/*CAM Buffer size increased - Fix for loading menu based controls */
...
static unsigned int g_bload_flashaddr = 0x0000;

static uint8_t *fw_version = NULL;

/* CAM communication variables */
...
static unsigned short int g_bload_crc16 = 0x0000;

static const char g_mcu_fw_buf[] =
#include "eCAM130_CURB_FW_1056MHZ.txt"
;
