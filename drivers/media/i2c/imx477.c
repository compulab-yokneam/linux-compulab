 ...
 * Returns always zero
 */
static int imx477_camera_link_setup(struct media_entity *entity,
...
static const struct media_entity_operations imx477_camera_sd_media_ops = {
	.link_setup = imx477_camera_link_setup,
};
...
static int imx477_probe(struct i2c_client *client)
{
	...
	imx477->sd.entity.ops = &imx477_camera_sd_media_ops;
